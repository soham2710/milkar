...
export default function Home() {
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote: "Thanks to MILKAR, I got a 15% discount on my dream villa in Vijay Nagar. The collective buying approach really works!"
    },
    {
      id: 2,
      name: "Priya Sharma",
      ...
      quote: "I was skeptical at first, but MILKAR delivered on their promise. Got a great deal on my apartment and saved lakhs of rupees."
    },
    {
      id: 3,
      name: "Vivek Agarwal",
      ...
      quote: "As an investor, I've purchased multiple properties through MILKAR. Their approach consistently gets me better returns on investment."
    }
  ];
  ...
  return (
    <div className="pt-16"> {/* Adding padding top to account for fixed navbar */}
      ...
      {/* Companies/Builders Section */}
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <p className="text-gray-500">TRUSTED BY LEADING BUILDERS</p>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
            {[1, 2, 3, 4, 5].map((builder) => (
              <div key={builder} className="grayscale hover:grayscale-0 transition-all duration-300">
                <div className="h-12 w-32 bg-gray-200 rounded flex items-center justify-center">
                  <span className="font-semibold text-gray-500">Builder {builder}</span>
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="relative bg-white rounded-xl shadow-lg p-8 md:p-12">
              <div className="absolute top-0 right-0 transform translate-x-1/4 -translate-y-1/4">
                <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M36 60H12V36H36V60ZM96 60H72V36H96V60Z" fill="#EA580C" fillOpacity="0.1"/>
                </svg>
              </div>
                  ...
                  <div className="mb-6 md:mb-0 md:mr-8">
                    <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-orange-100">
                      <div className="w-full h-full bg-orange-200 flex items-center justify-center">
                        <span className="text-orange-600 font-bold text-xl">{testimonials[currentTestimonial].name.charAt(0)}</span>
                      </div>
                    </div>
                  </div>
                  
                  <div>
                    <svg className="h-8 w-8 text-orange-200 mb-4" fill="currentColor" viewBox="0 0 32 32">
                    ...
                    <div>
                      ...
                      <p className="text-orange-600">{testimonials[currentTestimonial].role}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-between mt-12">
                <button 
                  ...
                  className="p-2 rounded-full border border-gray-200 hover:bg-orange-50 transition-colors"
                >
